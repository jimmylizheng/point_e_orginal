...
def main():
    ...
    # Set prompts to condition on.
    prompts = ['a yellow duck','a red motorcycle', 'a pink cat']
    
    # loop for latency test
    for prompt in prompts:
        print(f"Start to generate {prompt}")
        gpu_memory = get_gpu_memory_usage()
        ...
        print(f"Finish point cloud generation of {prompt}")
        gpu_memory = get_gpu_memory_usage()
        print(f"Current GPU Memory Usage: {gpu_memory} MiB")
